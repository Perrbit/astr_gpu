...
- [ ] **Step 1: Write scanner unit tests against temporary miniature repositories**
...
- [ ] **Step 3: Implement source discovery and Fortran lexical parsing**
...
- [ ] **Step 5: Commit the scanner foundation**
...
- [ ] **Step 1: Add failing tests for CMake and evidence contracts**
...
- [ ] **Step 2: Run tests and verify failures identify missing interfaces**
...
- [ ] **Step 3: Implement the inventory snapshot and command interface**
...
- [ ] **Step 4: Run unit tests and generate the real inventory**
...
- [ ] **Step 5: Prove the stale-inventory gate fails without changing tracked output**
...
- [ ] **Step 6: Commit the complete inventory tool**
...
- [ ] **Step 1: Write the navigation page with one Mermaid flowchart**
...
- [ ] **Step 2: Write repository ownership with one Mermaid flowchart and complete source groups**
...
- [ ] **Step 3: Validate coverage and links available at this stage**
...
- [ ] **Step 1: Build the current layered architecture diagram**
...
- [ ] **Step 2: Build the core module dependency diagram**
...
- [ ] **Step 3: State implemented ownership and explicit limits**
...
- [ ] **Step 4: Validate all current claims against source anchors and commit**
...
- [ ] **Step 1: Write the startup flow diagram from the program call order**
...
- [ ] **Step 2: Write separate CPU and GPU RK lanes in one sequence diagram**
...
- [ ] **Step 3: Write the field ownership state diagram**
...
- [ ] **Step 4: Validate ordering and commit**
...
- [ ] **Step 1: Write the decomposition and neighbor contract**
...
- [ ] **Step 2: Draw the GPU halo sequence**
...
- [ ] **Step 3: Compare CPU and GPU communication semantics**
...
- [ ] **Step 4: Bind communication changes to evidence**
...
- [ ] **Step 1: Draw the target backend architecture without implying completion**
...
- [ ] **Step 2: Write target migration rules**
...
- [ ] **Step 3: Write numerical contract summaries**
...
- [ ] **Step 4: Link formulas instead of duplicating them**
...
- [ ] **Step 5: Validate terminology, target labels, and commit**
...
- [ ] **Step 2: Write run and device-binding contracts**
...
- [ ] **Step 3: Write the restart state machine and checklist**
...
- [ ] **Step 4: Validate commands without launching a solver job**
...
- [ ] **Step 1: Write six change-impact recipes**
...
- [ ] **Step 2: Draw the layered validation gate**
...
- [ ] **Step 3: Write troubleshooting entries in the fixed five-part format**
...
- [ ] **Step 4: Link concrete validation entry points**
...
- [ ] **Step 1: Refresh the inventory at final `HEAD` and prove determinism**
...
- [ ] **Step 2: Run tests, placeholder scan, relative-link scan, and Git whitespace checks**
...
- [ ] **Step 3: Extract and temporarily render all ten Mermaid blocks**
...
- [ ] **Step 4: Perform the acceptance audit**
...
- [ ] **Step 5: Commit the final synchronized maintenance set**
