...
更新日期：2026-09-11。当前代码基线：`feature/gpu_dev`，提交
`42f5511f84ce3b14d745fd5db820d8d1279c426d` 加当前未提交 D2 工作树。
...
- 下一步只有具体黏性算例需要时，才加入黏性特征源项并扩展到其他开放面。
...
3. 完成动态入口 D3 前驱统计收敛，并在 A800 上复核已完成的 D4 常驻统计性能，
   再进入生产级湍流 SBLI。
