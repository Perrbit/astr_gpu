...
contains
   ...
   subroutine write_vtk_binary(filename, rho, vel, prs, tmp)
      ...
      real(8), intent(in), optional :: rho(-hm:im + hm, -hm:jm + hm, -hm:km + hm)
      real(8), intent(in), optional :: vel(-hm:im + hm, -hm:jm + hm, -hm:km + hm, 1:3)
      real(8), intent(in), optional :: prs(-hm:im + hm, -hm:jm + hm, -hm:km + hm)
      real(8), intent(in), optional :: tmp(-hm:im + hm, -hm:jm + hm, -hm:km + hm)
