...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/tests/gpu_validation/out/openshock_s0b3_sponge}"
GRID="${GRID:-400,8,8}"
NP="${NP:-1}"
...
DELTAT="${DELTAT:-1.d-4}"
POUT="${POUT:-1.0333333333333333d1}"
SPONGE="${SPONGE:-0,80,0,0,0,0}"
