...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/tests/gpu_validation/out/curvilinear_hbl_c10_viscous_selective_roe}"
if [[ "$OUT_DIR" != /* ]]; then
...
LCHARDECOMP=t DIFFTERM=t SPONGE_IM=0 UPPER_BCTYPE=51 XMIN_BCTYPE=11 \
