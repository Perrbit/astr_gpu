...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/tests/gpu_validation/out/curvilinear_hbl_c12_nscbc_sponge}"
if [[ "$OUT_DIR" != /* ]]; then
...
LCHARDECOMP=t DIFFTERM=t SPONGE_IM="$SPONGE_IM" UPPER_BCTYPE=52 XMIN_BCTYPE=12 \
